...
public abstract class UPCEANReader extends OneDReader {
    ...
    /**
     * @param row        row of black/zxing_white values to search
     * @param rowOffset  position to start search
     * @param whiteFirst if true, indicates that the pattern specifies zxing_white/black/zxing_white/...
     *                   pixel counts, otherwise, it is interpreted as black/zxing_white/black/...
     * @param pattern    pattern of counts of number of black and zxing_white pixels that are being
     ...
     *
     * @param row       row of black/zxing_white values to decode
     * @param counters  the counts of runs of observed black/zxing_white/black/... values
