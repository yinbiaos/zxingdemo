...
public final class ITFReader extends OneDReader {
    ...
    private static void decodeMiddle(BitArray row,
        ...
        // 5
        // interleaved zxing_white lines for the second digit.
        ...
        while (payloadStart < payloadEnd) {
            ...
            // Get 10 runs of black/zxing_white.
     ...
     * @param pattern   pattern of counts of number of black and zxing_white pixels that are
    ...
    /**
     * Attempts to decode a sequence of ITF black/zxing_white lines into single
     * digit.
     *
