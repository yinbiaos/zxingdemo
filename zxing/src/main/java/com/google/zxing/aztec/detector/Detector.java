...
public final class Detector {
    ...
    private ResultPoint[] getBullsEyeCorners(Point pCenter) throws NotFoundException {
        ...
        // between the zxing_white square and the black square
    ...
    private Point getMatrixCenter() {
        ...
        //Get a zxing_white rectangle that can be the border of the matrix in center bull's eye or
        try {
            ...
            // This exception can be in case the initial rectangle is zxing_white
        ...
        // Redetermine the zxing_white rectangle starting from previously computed center.
        // This will ensure that we end up with a zxing_white rectangle in center bull's eye
    ...
    /**
     * @return true if the border of the rectangle passed in parameter is compound of zxing_white points only
     ...
     *
     * @return 1 if segment more than 90% black, -1 if segment is more than 90% zxing_white, 0 else
     */
