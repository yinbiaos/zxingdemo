 ...
 * high frequency images of barcodes with black data on zxing_white backgrounds. For this application,
        ...
        for (int y = 0; y < subHeight; y++) {
            ...
            for (int x = 0; x < subWidth; x++) {
                ...
                if (max - min <= MIN_DYNAMIC_RANGE) {
                    ...
                    // low contrast area into black and zxing_white pixels, essentially creating data out of noise.
                    //
                    ...
                    if (y > 0 && x > 0) {
                        // Correct the "zxing_white background" assumption for blocks that have neighbors by comparing
