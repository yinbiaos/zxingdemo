...
public final class Detector {
    ...
    public DetectorResult detect() throws NotFoundException {
        ...
        // will be the two alternating black/zxing_white sides
        ...
        // Next determine the dimension by tracing along the top or right side and counting black/zxing_white
        // transitions. Since we start inside a black module, we should see a number of transitions
        // equal to 1 less than the code dimension. Well, actually 2 less, because we are going to
        // end on a black module:

        // The top right point is actually the corner of a module, which is one of the two black modules
        // adjacent to the zxing_white module at the top right. Tracing to that corner from either the top left
        ...
        if (4 * dimensionTop >= 7 * dimensionRight || 4 * dimensionRight >= 7 * dimensionTop) {
            ...
            // correct top right point to match the zxing_white module
    ...
    /**
     * Calculates the position of the zxing_white top right module using the output of the rectangle detector
    ...
    /**
     * Counts the number of black/zxing_white transitions between two points, using something like Bresenham's algorithm.
     */
