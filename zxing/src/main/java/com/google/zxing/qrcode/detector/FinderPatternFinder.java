...
public class FinderPatternFinder {
    ...
    protected static final int MAX_MODULES = 97; // support up to version 20 for mobile clients  //version 10的时候这个值是56
    ...
    private static final class CenterComparator implements Comparator<FinderPattern>, Serializable {
        ...
        public int compare(FinderPattern center1, FinderPattern center2) {
            if (center2.getCount() == center1.getCount()) {
                return Float.compare(Math.abs(center1.getEstimatedModuleSize() - average), Math.abs(center2.getEstimatedModuleSize() - average));
            } else {
