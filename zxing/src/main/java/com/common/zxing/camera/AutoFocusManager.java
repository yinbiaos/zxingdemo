...
final class AutoFocusManager implements Camera.AutoFocusCallback {
    ...
    public synchronized void onAutoFocus(boolean success, Camera theCamera) {
        if (active) {
            outstandingTask = new AutoFocusTask(this);
    ...
    private static final class AutoFocusTask extends AsyncTask<Object, Object, Object> {
        ...
        private WeakReference<AutoFocusManager> weak;

        private AutoFocusTask(AutoFocusManager manager) {
            this.weak = new WeakReference<>(manager);
        }
        ...
        protected Object doInBackground(Object... voids) {
            ...
            synchronized (AutoFocusTask.this) {
                if (weak.get().active && weak.get() != null) {
                    weak.get().start();
                }
            }
            return null;
