...
public final class ViewfinderView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            canvas.drawBitmap(((BitmapDrawable) (getResources().getDrawable(R.drawable.zxing_scan_laser))).getBitmap(),
                    null, lineRect, paint);
            ...
            canvas.drawText(getResources().getString(R.string.zxing_bottom_hint), width / 2, frame.bottom + (float) TEXT_PADDING_TOP * density, paint);
            canvas.drawText(getResources().getString(R.string.zxing_bottom_hint2), width / 2, (float) (frame.bottom + (float) TEXT_PADDING_TOP * density * 1.5), paint);
